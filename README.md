...
- **Safer Social Preview Loading**: Social preview now skips restricted tabs and falls back to a placeholder without throwing runtime errors.
- **Improved Popup Stability**: Added explicit Chrome API error handling to avoid unchecked `runtime.lastError` warnings.
